...
public class BookingRepository {
  ...
  private Booking mapBookings(ResultSet rs) throws SQLException {
    ...
    booking.setStartTime(rs.getObject("start_time", Instant.class));
    booking.setEndTime(rs.getObject("end_time", Instant.class));
  ...
  public Booking create(Booking booking){
    ...
    String sql = """
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?)
      """;
    jdbcTemplate.update(sql, booking.getId(), booking.getStartTime(), booking.getEndTime(), booking.isPaid(),
      booking.getCost(),booking.getVehicle().getId(), booking.getParkingSpot().getId());
  ...
  public Booking update(Booking booking){
    String sql = """
      ...
      WHERE id = ?
      """;
    jdbcTemplate.update(sql,booking.getStartTime(), booking.getEndTime(), booking.isPaid(), booking.getCost(),
      booking.getVehicle().getId(), booking.getParkingSpot().getId(), booking.getId());
